...
<style>
    ...
    .projects-wrapper.d-fc.container-1280 {     padding: 0px 0px; }
    ...
    <div class="homepage-wrapper d-fc">
        ...
        <?php $i=0;?>
            ...
            <div class="homepage-slider-wrapper" style="width:100%; min-height : 500px;background : url('/masters/owl-master/css/ajax-loader.gif') no-repeat;  background-position:center 250px; ">
                ...
                <div class="calculate-box for-desktop">
                    ...
                    <button class="accordion calculate-box-top">
                        ...
                        <div class="box-logo"><img src="{{ asset('images/logos/form-logo-1.png') }}" "form-logo" alt="form logo" height="25px"></div>
                        ...
                        <form action="/sliderform" method="post" id="form_1">
                            ...
                            <div class="cal-form-1">
                                ...
                                <div class="checkbox-div">
                                    ...
                                    <input type="checkbox" name="is_company" aria-label="checkbox" class="cal1-input-check">
        ...
        <div class="homepage-video-wrapper d-flex container-1280 new-section-home justify-content-between">
                ...
                <div class="video">
                    ...
                    <div class="right-block" <?php if($agent->isMobile()) echo 'style="width:345px"'; ?> ></div>

                </div>

                        <div class="text d-fc"  <?php if($agent->isMobile()) echo 'style="margin:0px; width:100%;"'; ?> >
                ...
                <div class="lower">
                    ...
                    <div class="right">
                        ...
                        <a class="fa" aria-label="follow facebook" href="https://www.facebook.com/metrixgeorgia/"></a>

                    <a class="ig" aria-label="follow instagram" href="#"></a> 
...
-->
        ...
        <div class="d-flex container-1280 pt-5 pb-5 cat-div-mobile">
            ...
            <div class="row m-0 justify-content-between <?php if(!$agent->isMobile()) echo 'pl-4'; ?> desktop-small">

                <div class="col-md-5 home-cat p-0" <?php if($agent->isMobile()) echo 'style="margin-left:0px;"'; ?> >

                    <div class="cat-box row <?php if(!$agent->isMobile()) echo 'pl-3'; ?>">
            ...
            <div class="col-md-5 home-cat ser" id="service-repairs" <?php if($agent->isMobile()) echo 'style="padding-left:0px; padding-right:0px"'; ?>>

                <div class="right-box  cat-rightbox-custom" <?php if($agent->isMobile()) echo 'style="margin-left:0px;"'; ?>>
