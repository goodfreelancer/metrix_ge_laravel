...
<p class="my-5">დირექტორი: შალვა მჭედლიშვილი</p>


<table class="w-100">
    <tr>
        <td class="w-100 border border-bottom-0 py-2 px-3">
თანხის გადახდის დროს დანიშნულებაში  ინვოისის ნომერის მითითება სავალდებულოა, თუ განხორციელდა თანხის ჩარიცხვა მიმღების ანგარიშზე, ინვოისს ექნება მიღება-ჩაბარების აქტის ძალა და მომსახურება ჩაითვლება გაწეულად.
        </td>
    </tr>
</table>
<table class="w-100">
