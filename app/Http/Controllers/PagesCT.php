    ...
    // * Pages
        // * Singular
            ...
            public function slider_invoice(Request $request,SmsOffice $smsoffice) {
                ...
                $calculate_form = !empty($request->input('calculate_form')) ? $request->input('calculate_form') : $request->input('calculate_form2');
                ...
                // $data['1'] = $request->input('calculate_form');
                // $data['2'] = $frm['square_limit'];
                // $data['3'] = $calculate_form;
                // $data['4'] = $price;
                // $data['5'] = $request->input('calculate_form2');
                // return json_encode($data);
                if ( Repairs::where('id', 1)->exists() ) {
                    $repairs = Repairs::find(1);
                    //$flat_size = (int)$request->flat_size;
